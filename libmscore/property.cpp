...
static constexpr PropertyMetaData propertyList[] = {
      ...
      { Pid::SHOW_COURTESY,             P_TYPE::INT,            false, "showCourtesySig",        DUMMY_QT_TRANSLATE_NOOP("propertyName", "show courtesy")                                 },
      ...
      { Pid::NO_STEM,                   P_TYPE::INT,            false, "noStem",                 DUMMY_QT_TRANSLATE_NOOP("propertyName", "no stem")                                       },
