...
<context>
    ...
    <message>
        ...
        <translation>MuseScore에 오신 것을 환영합니다! 이 간단한 둘러보기는 MuseScore의 사용법을 안내할 것입니다.</translation>
    </message>
    <message>
        <source>The Playback Controls toolbar allows you to play/pause your score and control various aspects of playback.</source>
        <comment>welcome</comment>
        <translation>재생 제어 툴바는 재생/정지 혹은 다양한 조절을 통해 곡의 재생을 돕습니다.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <comment>welcome</comment>
        <translation>팔레트는 많은 악상 기호를 입력할 수 있게 해줍니다.</translation>
    </message>
    <message>
 ...
 다른 성부를 입력하려면 다음 아이콘 중 하나를 누르십시오.</translation>
    ...
    The main three are File Operations, Playback Controls, and Note Input.</source>
        <comment>welcome</comment>
        <translation>이것은 툴바입니다.
주로 파일 작업과 재생 제어, 그리고 음표 입력을 할 수 있습니다.</translation>
    </message>
    <message>
...
이 기능을 키고 끄려면 단축키 &quot;M&quot;을 누르세요.</translation>
    ...
    Click &quot;Next&quot; to learn more.</source>
        <comment>note-input</comment>
        <translation>음표 입력에 오신 것을 환영합니다. 여기서는 음표를 악보에 입력할 수 있습니다. &quot;다음&quot;을 누르십시오.</translation>
    </message>
    <message>
...
&quot;다음&quot;을 누르십시오.</translation>
    ...
    Click &quot;Next&quot; to learn more.</source>
        ...
        <translation>인스펙터에 오신것을 환영합니다. 여기서는 선택된 요소의 개별적 속성을 변경할 수 있습니다. &quot;다음&quot;을 누르십시오.</translation>
    </message>
    <message>
    ...
    The set of properties available will differ according to the type of selected elements or elements.</source>
        <comment>inspector-tour</comment>
        <translation>인스펙터는 악보에서 하나 이상의 요소를 선택하여 시작할 수 있습니다. 체크 박스, 스핀 박스, 드롭다운 메뉴 및 기타 컨트롤을 사용해 다양한 속성값을 변경합니다.
유효한 속성 집합은 선택한 요소의 유형에 따라 다릅니다.</translation>
    </message>
    <message>
    ...
    You can click the &quot;Notes&quot; and other buttons at the bottom of the Inspector to limit the selection to just the elements of the specified type.</source>
        <comment>inspector-tour</comment>
        <translation>서로 다른 유형의 요소를 선택한 경우, 모든 요소에 공통적인 몇 가지 설정만 변경이 가능합니다.
Inspector 하단에 있는 &quot;Notes&quot; 및 기타 버튼을 클릭하여 지정된 유형의 요소만 선택하도록 제한할 수 있습니다.</translation>
    </message>
    <message>
        <source>The Inspector allows you to control various properties of the elements in your score.</source>
        <comment>welcome</comment>
        <translation>인스펙터는 악보를 구성하는 모든 요소의 속성을 변경할 수 있게 해줍니다.</translation>
    </message>
    <message>
    ...
    Click &quot;Next&quot; to learn more.</source>
        ...
        <translation>자동 배치는 요소간의 여러 유형의 충돌을 자동으로 감지하고 방지하는 새로운 기능입니다.
자동 배치된 요소들의 위치를 수동으로 조정할 수도 있고, 선택된 요소의 자동 배치를 비활성화할 수 있습니다.
&quot;다음&quot;을 눌러 더 알아봅시다.</translation>
    </message>
    <message>
    ...
    This will remove them from collision detection and allow you to place them more freely.</source>
        <comment>autoplace-tour</comment>
        <translation>더 큰 조정을 위해서는 인스펙터를 사용하여 선택된 요소의 자동 배치를 비활성화 하는 것이 더 편할 수도 있습니다.
그러면 충돌 감지는 없어지고, 더 자유롭게 배치할 수 있습니다.</translation>
    </message>
    <message>
    ...
    You can also set style defaults using Format &gt; Style….</source>
        <comment>inspector-tour</comment>
        <translation>만일 값을 수정했다면 &quot;초기화&quot; 버튼을 눌러 기본값으로 초기화할 수 있습니다.
또는 스타일 설정이 값을 제어하는 경우 &quot;Set as style&quot; 버튼을 눌러 현재 값을 스타일의 새 기본값으로 설정할 수 있습니다.
또한 Format &gt; 스타일… 메뉴에서 기본 스타일을 설정할 수 있습니다.</translation>
    </message>
    <message>
    ...
    To scroll horizontally, hold &quot;Shift&quot; while using the mouse wheel or touch gesture.</source>
        <comment>navigate-tour</comment>
        <translation>위나 아래로 스크롤하기 위한 가장 빠른 방법은 마우스 휠을 사용하거나 동등한 터치 제스처(예: 두 손가락 쓸기)를 사용하는 것입니다.
수평으로 스크롤하려면 마우스 휠이나 터치 제스처를 사용하는 동안 &quot;Shift&quot; 키를 누르십시오.</translation>
    </message>
    <message>
    ...
    Keyboards that lack these keys often provide equivalents such as &quot;Fn+Up/Down/Left/Right&quot;.</source>
        <comment>navigate-tour</comment>
        <translation>키보드의 &quot;PgUp&quot;, &quot;PgDn&quot;, &quot;Home&quot;, &quot;End&quot; 와 같은 탐색 키는 다른 응용 프로그램과 마찬가지로  페이지를 움직이도록 합니다. 
이런 키가 없는 키보드의 경우, &quot;Fn 키&quot; + &quot;Up/Down/Left/Right&quot; 키가 동일하게 대응됩니다.</translation>
    </message>
    <message>
    ...
    By the way, you can also select regions by holding &quot;Shift&quot; while dragging.</source>
        <comment>navigate-tour</comment>
        <translation>페이지의 빈 공간을 클릭하고 드래그하면 짧은 거리로 악보를 이동할 수 있습니다.
 한편 &quot;Shift&quot;를 누른채로 드래그하면 영역을 선택할 수 있습니다. </translation>
    </message>
    <message>
    ...
    Press &quot;Ctrl+Up/Down&quot; (macOS: &quot;Cmd+Up/Down&quot;) to change octave.</source>
        <comment>note-input</comment>
        <translation>선택한 길이의 음표를 입력하려면, 영어 계이름을 누르거나 보표를 클릭하세요.
옥타브를 바꾸려면  &quot;Ctrl+Up/Down&quot;를  누르세요(macOS: &quot;Cmd+Up/Down&quot;).</translation>
    </message>
    <message>
    ...
    or click one of these icons.</source>
        <comment>note-input</comment>
        <translation>음표에 임시표를 추가하려면, 단축키 &quot;위쪽 방향키&quot; 또는 &quot;아래쪽 방향키&quot;를 눌러 음높이를 올리거나 내립니다.
또는 이 아이콘을 클릭합니다.</translation>
    </message>
    <message>
        <source>To add a note to a chord, press &quot;Shift&quot; while typing its letter name, or click on the staff.</source>
        <comment>note-input</comment>
        <translation>코드에 음표를 추가하려면 &quot;shift&quot;를 누른채로 영어 계이름을 누르거나, 보표를 클릭하세요.</translation>
    </message>
    <message>
        ...
        <comment>note-input</comment>
        <translation>셋잇단음표나 잇단 음표를 생성하려면, 전체 잇단 길이를 선택한 다음 &quot;ctrl+숫자&quot; 를 누르거나 추가&gt;잇단음표를 사용하십시오.</translation>
    </message>
    <message>
    ...
    If you have multiple scores open, you can switch between them using tabs at the top of your score view.</source>
        <comment>welcome</comment>
        <translation>이것은 악보 뷰이며, 악보를 보고 편집할 수 있습니다. 
마우스 휠 또는 터치 패드로 스크롤합니다. (&quot;Shift&quot;를 누른 채 수평으로 스크롤합니다.)
악보가 여러개 열린 경우, 악보 뷰 위에 있는 탭으로 악보를 전환할 수 있습니다.</translation>
    </message>
    <message>
    ...
    The controls at the right of this toolbar control the display of your score.</source>
        <comment>welcome</comment>
        <translation>파일 작업 툴바는 파일을 생성/저장/열기/인쇄하고 변경 내용을 되돌리기/다시 실행할 수 있게 해줍니다.
파일 &gt; 온라인으로 저장...  메뉴로 파일을 musescore.com 계정으로 저장할 수도 있습니다.
그리고 툴바 오른편의 컨트롤을 사용해 악보 뷰 화면을 제어할 수 있습니다.</translation>
    </message>
    <message>
    ...
    In addition, many commands can be accessed via keyboard shortcuts or by right-clicking (macOS: &quot;Ctrl&quot;+clicking) within the score view.</source>
        <comment>welcome</comment>
        <translation>메인 메뉴에는 대부분의 명령이 포함되어 있습니다.
    추가적으로, 많은 명령은 키보드 단축키를 입력하거나 악보 뷰에서 오른쪽 클릭(macOS에서는 &quot;Ctrl&quot; + 클릭)하는 것으로 사용이 가능합니다.</translation>
    </message>
    <message>
    ...
    You can also enable/disable and reset tours in Help &gt; Tours.</source>
        <comment>welcome</comment>
        <translation>기본적인 둘러보기가 끝났습니다!
앞으로 MuseScore를 사용하는 중에 추가적으로 기능을 설명하는 둘러보기가 나타날 것입니다.
둘러보기를 더 이상 보고 싶지 않다면 이 창을 닫기 전에 &quot;둘러보기를 계속 표시하기&quot; 체크박스를 해제하십시오.
도움말 &gt; 둘러보기 에서 둘러보기 보기를 활성화/비활성화 하거나 둘러보기 초기화를 할 수도 있습니다.</translation>
    </message>
</context>
</TS>
