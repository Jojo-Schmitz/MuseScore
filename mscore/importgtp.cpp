...
void GuitarPro::initGuitarProDrumset()
      ...
      gpDrumset->drum(73) = DrumInstrument(QT_TRANSLATE_NOOP("drumset", u8"Short Güiro"), NoteHead::Group::HEAD_NORMAL, 3, MScore::Direction::UP);
      gpDrumset->drum(74) = DrumInstrument(QT_TRANSLATE_NOOP("drumset", u8"Long Güiro"), NoteHead::Group::HEAD_NORMAL, 3, MScore::Direction::UP);
